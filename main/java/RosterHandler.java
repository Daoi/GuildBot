...
public class RosterHandler {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = RosterHandler.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        ...
        return new AuthorizationCodeInstalledApp(flow, receiver).authorize("GuildBot");
    ...
    public static void updateRoster(String[] input, String[] name) throws IOException, GeneralSecurityException {
        ...
        try {
            Sheets service = new Sheets.Builder(HTTP_TRANSPORT, JSON_FACTORY, getCredentials(HTTP_TRANSPORT))
                    ...
                    .build();
            //This is what the data structure has to look like to apply, each data1 is a column, "update" is the row. Name/Input separated for convenience
            List<Object> data1 = new ArrayList<>();
                ...
                AppendValuesResponse appendResult = service.spreadsheets().values()
                        .append(spreadsheetId, "Roster", update)
